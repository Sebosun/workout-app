...
export default function User(): ReactElement | null {
  const linkClasses = "flex sm:flex-row items-center self-center justify-center h-48 text-4xl border-2 border-solid text-center max-w-sm lg:max-w-lg rounded-xl btn"
